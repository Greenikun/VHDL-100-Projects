...
- [x] [7-segment display driver (for 0–9)](https://github.com/TheChipMaker/85-SevenSeg-Driver).
- [x] [Binary to Gray code converter](https://github.com/TheChipMaker/84_Binary_to_Gray_Code_Converter).

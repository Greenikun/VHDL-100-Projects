...
## Main Files
- `AND_GATE.vhd`: VHDL code implementing the NOR gate entity and architecture.
- `AND_GATE_tb.vhd`: Testbench to simulate the NOR gate inputs and observe output behavior.
